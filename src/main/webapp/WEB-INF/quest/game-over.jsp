...
<div class="container py-4 py-xl-5 pt-lg-4 pb-lg-2 mt-lg-0 mt-0 pt-5" id="quest-div">
    <div class="row gy-4 gy-md-0" style="background: #973636;">
        <div class="col-md-6 d-xxl-flex pt-lg-0 mt-lg-0">
            <div class="border rounded p-xl-5 m-xl-5" style="background: #585858;">
                <img class="rounded img-fluid w-100 fit-cover pt-lg-0" style="min-height: 300px;"
                     src="assets/img/game_over.jpg" width="336" height="403">
            </div>
        </div>
            ...
            <div style="max-width: 350px;" class="pb-3">
                <p class="my-3 pt-lg-0 mt-lg-4 me-lg-0 pe-lg-0 pb-lg-0"
                   style="font-size: 18px;color: rgb(238,238,238);">
                    <strong>Причина</strong></p>
                <h2 class="fw-semibold me-lg-0 pe-lg-0 pb-lg-0 mb-lg-0"
                    style="font-size: 31px;color: rgb(255,255,255);">
                    <strong><%=session.getAttribute("questName") + result%>
                    </strong>
                </h2>
                <p class="my-3 pt-lg-0 mt-lg-4 me-lg-0 pe-lg-0 pb-lg-0"
                   style="font-size: 18px;color: rgb(238,238,238);"></p>
                <button class="btn btn-dark btn-lg border rounded me-2" type="button" id="start"
                        style="background: rgb(235,235,235);color: #293555;">Начать сначала
                </button>
            </div>
        </div>
    </div>
    ...
    $("#start").click(function () {
        $.ajax({
            ...
            , data: {                    // Параметры запроса
                id: 1,                   // Параметр 'id' со значением '1'
