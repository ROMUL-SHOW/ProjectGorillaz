<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    String result = "";
    if(requestParameter.equals("decline-1")){
        result = " отклонил вызов.";
    }
    if(requestParameter.equals("decline-2")){
            result = " не пошел на переговоры.";
    }
    if(requestParameter.equals("decline-3")){
            result = " не умеет врать.";
    }
    %>
<div class="container py-4 py-xl-5 pt-lg-4 pb-lg-2 mt-lg-0 mt-0 pt-5" id="quest-div">
    <div class="row gy-4 gy-md-0" style="background: #870000;">
        <div class="col-md-6 d-xxl-flex pt-lg-0 mt-lg-0">
            <div class="border rounded p-xl-5 m-xl-5" style="background: #585858;">
                <img class="rounded img-fluid w-100 fit-cover pt-lg-0" style="min-height: 300px;" src="assets/img/game_over.jpg" width="336" height="403">
            </div>
        </div>
        <div class="col-md-6 d-md-flex align-self-center align-items-md-center" style="font-size: 15px;background: #262626b6;box-shadow: inset 0px 7px rgb(255,255,255);">
            <div style="max-width: 350px;" class="pb-3">
                ...
                <h2 class="fw-semibold me-lg-0 pe-lg-0 pb-lg-0 mb-lg-0" style="font-size: 31px;color: rgb(255,255,255);">
                    <strong><%=session.getAttribute("questName") + result%></strong>
                </h2>
